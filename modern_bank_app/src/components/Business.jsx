  ...
  return (
   <section id='featues' className={layout.section}>
    <div className={layout.sectionInfo}>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>With the right credit card, you can improve financial life by building credit, earning rewards and saving money.
